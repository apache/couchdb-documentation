...
The CouchDB Server Node API provides an interface to query and
update the various configuration values of single nodes in a CouchDB cluster
on ``/_node/{fqdn}/_config``.

It also allows access to statistics for a given node using
``/_node/{fqdn}/_stats``.
...
.. http:get:: /_node/{fqdn}/_config
    :synopsis: Obtains a list of the entire node configuration

    Returns the entire CouchDB node configuration as a JSON structure. The
    ...
    **Request**
    ...
    .. code-block:: http
        ...
        GET /_node/node1/_config HTTP/1.1
...
``/_node/{fqdn}/_config/section``
====================

.. http:get:: /_node/{fqdn}/_config/{section}
    ...
    **Request**:
    ...
    .. code-block:: http
        ...
        GET /_node/node1/_config/httpd HTTP/1.1
        Accept: application/json
        Host: localhost:5984
...
``/_node/{fqdn}/_config/section/key``
========================

.. http:get:: /_node/{fqdn}/_config/{section}/{key}
    ...
    **Request**:
    ...
    .. code-block:: http
        ...
        GET /_node/node1/_config/log/level HTTP/1.1
        Accept: application/json
        Host: localhost:5984
...
.. http:put:: /_node/{fqdn}/_config/{section}/{key}
    ...
    For a cluster with two or more nodes the usage of this endpoint unreliable
    and **not** recommended!
    ...
    **Request**:
    ...
    .. code-block:: http
        ...
        PUT /_node/node1/_config/log/level HTTP/1.1
        Accept: application/json
        Content-Length: 7
        Content-Type: application/json
        Host: localhost:5984
...
.. http:delete:: /_node/{fqdn}/_config/{section}/{key}
    ...
    **Request**:
    ...
    .. code-block:: http
        ...
        DELETE /_node/node1/_config/log/level HTTP/1.1
        Accept: application/json
        Host: localhost:5984
...
Returns the statistics for a given node.
